...
- chore: update Go to 1.27.1 and github.com/bborbe/errors to v1.6.1, github.com/bborbe/http to v1.26.26, github.com/bborbe/kafka to v1.25.16, github.com/bborbe/run to v1.10.2, github.com/bborbe/sentry to v1.10.1, github.com/bborbe/service to v1.10.13, github.com/bborbe/time to v1.27.14, github.com/onsi/gomega to v1.43.0
...
- Update golang.org/x/crypto, x/net, x/sys, x/text to latest
- Improve vulncheck with configurable ignore list (VULNCHECK_IGNORE)
- Add fix target for bulk dependency updates

## v1.6.20

- Bump Go toolchain to 1.26.3
- Update IBM/sarama v1.47.0 → v1.48.0
- Update bborbe/* dependencies (errors, log, run, sentry, service, time, collection)
- Update getsentry/sentry-go v0.46.1 → v0.46.2
...
- Update github.com/bborbe/errors v1.5.1 → v1.5.2
- Update github.com/bborbe/log v1.6.1 → v1.6.2
- Update github.com/bborbe/sentry v1.9.4 → v1.9.6
- Update github.com/bborbe/time v1.21.1 → v1.22.0
